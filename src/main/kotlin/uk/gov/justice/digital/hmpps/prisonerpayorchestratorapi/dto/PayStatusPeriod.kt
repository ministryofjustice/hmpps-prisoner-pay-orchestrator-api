...
data class PayStatusPeriod(
  ...
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "The prisoner's first name", example = "Joe")
  val firstName: String,

  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "The prisoner's last name", example = "Bloggs")
  val lastName: String,

  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "The prisoner's residential cell location when inside the prison", example = "A-1-002")
