...
import uk.gov.justice.digital.hmpps.prisonerpayorchestratorapi.client.PayStatusPeriod as PrisonerPayStatusPeriod

internal fun PrisonerPayStatusPeriod.toModel(prisoner: Prisoner) = PayStatusPeriod(
  id = id,
